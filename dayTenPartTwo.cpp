...
namespace DayTenPartTwo
{
	namespace {
		...
		void findPeaks(const square_vect_t& intSquare, const coord_t& startCoord, size_t& peakCount, const int kSquareLen)
		{
		...
		{
			size_t peakCount = 0;
			findPeaks(intSquare, startCoord, peakCount, kSquareLen);
			return peakCount;
		}
	...
	void dayTenPartTwo() {
		std::system("cls");
		std::cout << "Running program DayTenPartTwo" << '\n';
